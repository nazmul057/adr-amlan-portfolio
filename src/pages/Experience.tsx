                ...
                <React.Fragment key={item.id}>
                    ...
                    <div className="flex flex-col pb-16">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="mt-2 flex flex-col gap-2">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    aria-label="Open external company link"
                                    className="
                            ...
                            {/* Role title + engagement */}
                            <div className="mt-3 flex flex-wrap items-center gap-2">
                            <p className="text-lg font-medium text-primary">{item.title}</p>

                            {item.engagement && (
                                <span className="inline-flex h-6 items-center rounded-md bg-primary/10 px-2.5 text-xs font-medium text-primary">
                                {item.engagement}
                                </span>
                            )}
                            </div>
                        ...
                        <details className="group" open={index === 0}>
                            ...
                            <span className="text-sm font-medium text-white/90">Role Details</span>
                            <ChevronDown
                                size={18}
                            ...
                            {item.details && item.details.length > 0 ? (
                                ...
                                Led development of scalable solutions and contributed to core engineering initiatives.
                                </p>
                            )}
